...
if ! checkinstall vncserver; then
    ...
    wget -q -O /tmp/libssl1.1.deb http://ftp.debian.org/debian/pool/main/o/openssl/libssl1.1_1.1.1w-0+deb11u1_amd64.deb
...
echo "Run 'pm2 logs kasmvnc --lines 1000' to see the logs." >&2
echo "Run 'pm2 delete kasmvnc' to delete the process." >&2
